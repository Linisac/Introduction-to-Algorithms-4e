...
\newcommand{\seqe}[1]{\left\langle#1\right\rangle} %sequence by enumeration: \seqe{1, 2, 3} gives \langle 1, 2, 3 \rangle
...
\newcommand{\by}{\times} %matrix dimension
%%Integer functions
...
\newcommand{\preimage}[1]{#1^\circ} %preimage (of a function)
...
\newenvironment{proofloopinv}{\begin{description}}{\end{description}} %proof of loop invariant
\newcommand{\Init}{\item[Initialization:]} %ingredient of the new environment `proofloopinv'
\newcommand{\Main}{\item[Maintenance:]} %ingredient of the new environment `proofloopinv'
\newcommand{\Term}{\item[Termination:]} %ingredient of the new environment `proofloopinv'
\newenvironment{enumloopinv}{\begin{enumerate}[(1)]}{\end{enumerate}} %enumeration inside a loop invariant
\newenvironment{recurcorr}{\begin{quote}}{\end{quote}} %recursion correctness
\newenvironment{proofinduct}{\begin{description}}{\end{description}} %proof by induction
\newcommand{\Basis}{\item[Basis step:]} %ingredient of the new environment `proofinduct'
\newcommand{\Induct}{\item[Inductive step:]} %ingredient of the new environment `proofinduct'
\theoremstyle{remark}
